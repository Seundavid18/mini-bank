...
import './Dribble.css'
import dribbleImg from '../../../Images/504-5040388_dribbble-logo-icon-png-image-free-download-searchpng.png'
...
export default function Dribble() {
  ...
  return (
    <>
        <div className='shortcard' data-bs-toggle="modal" data-bs-target="#dribbleModal">
            <div className='d-flex justify-content-center'>
                <img src={dribbleImg} alt="" className='shortImg' />
            </div>
            <h6 className='short mt-4 text-center'>Dribble</h6>
        </div>

        {/* Add Modal */}
      <div className="modal fade" id="dribbleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  ...
                  <div className="mb-3">
                      <label className='modal-label'>Account Number</label>
                        <select className="modal-bank-apple form-control" required onChange={handleAccount}>
                            ...
                            <option value="163973">163973</option>
                        </select>
                  </div>
                  <div className="mb-3">
                  ...
                  <div className="mb-3">
                      <label className='modal-label'>Type</label>
                        <select className='modal-bank-apple form-control' required onChange={handleAmount}>
                            ...
                            <option value="120">Graphics Design Plan - $120</option>
                            <option value="105">UI Plan - $105</option>
                            <option value="140">Developer Game Plan - $140</option>
                            <option value="300">Dribble Combo Game Plan - $300</option>
                        </select>
                  </div>
                    {showOption &&
                        <div className="mb-3">
