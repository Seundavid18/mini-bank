...
export default function Profile() {
  ...
  return (
    <>
        <img className="nav-item nav-dp" src={file ? URL.createObjectURL(file) : PF + user.profilePicture} alt="" data-bs-toggle="modal" data-bs-target="#addMobileProfileModal"/>
        <h5 className='fs-6 fw-bold mt-2 ms-4 text-secondary nav-name'>{user.fullName}</h5>

         {/* Add Modal */}
                <div className="modal fade" id="addMobileProfileModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
